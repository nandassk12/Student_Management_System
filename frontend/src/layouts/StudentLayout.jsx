 ...
 * StudentLayout
 *
 * Uses the same AppShell as AdminLayout and TeacherLayout (Sidebar + Navbar + scrollable main).
 * The Sidebar component automatically renders student-specific nav items
